package me.fantasyfreedom.fantasyfreedommod.player;
...
import me.fantasyfreedom.fantasyfreedommod.caging.CageData;
import me.fantasyfreedom.fantasyfreedommod.config.ConfigEntry;
import me.fantasyfreedom.fantasyfreedommod.freeze.FreezeData;
...
public class FPlayer
{
    ...
    @Getter
    private final FantasyFreedomMod plugin;
    @Getter
    ...
    public FPlayer(FantasyFreedomMod plugin, Player player)
    {
        this(plugin, player.getName(), Ips.getIp(player));
    }

    private FPlayer(FantasyFreedomMod plugin, String name, String ip)
    {
        this.plugin = plugin;
        this.name = name;
        this.ip = ip;
    ...
    public void startArrowShooter(FantasyFreedomMod plugin)
    {
