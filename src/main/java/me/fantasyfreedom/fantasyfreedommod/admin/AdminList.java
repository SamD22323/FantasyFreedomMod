package me.fantasyfreedom.fantasyfreedommod.admin;
...
import me.fantasyfreedom.fantasyfreedommod.command.Command_logs;
...
public class AdminList extends FreedomService
{
    ...
    public AdminList(FantasyFreedomMod plugin)
    {
        super(plugin);
