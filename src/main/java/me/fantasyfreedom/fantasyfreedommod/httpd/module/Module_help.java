...
import me.fantasyfreedom.fantasyfreedommod.command.FreedomCommand;
import static me.fantasyfreedom.fantasyfreedommod.httpd.HTMLGenerationTools.heading;
import static me.fantasyfreedom.fantasyfreedommod.httpd.HTMLGenerationTools.paragraph;
import me.fantasyfreedom.fantasyfreedommod.httpd.NanoHTTPD;
import me.fantasyfreedom.fantasyfreedommod.rank.Displayable;
...
public class Module_help extends HTTPDModule
{
    ...
    public Module_help(FantasyFreedomMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String getBody()
    {
        ...
        while (it.hasNext())
        {
            ...
            {
                if (!FantasyFreedomMod.pluginName.equals(pluginName))
                {
