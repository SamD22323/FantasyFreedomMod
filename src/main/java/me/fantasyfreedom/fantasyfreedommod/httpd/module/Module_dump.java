...
import static me.fantasyfreedom.fantasyfreedommod.httpd.HTMLGenerationTools.list;
...
public class Module_dump extends HTTPDModule
{
    ...
    public Module_dump(FantasyFreedomMod plugin, NanoHTTPD.HTTPSession session)
    {
