package me.fantasyfreedom.fantasyfreedommod.freeze;
...
import static me.fantasyfreedom.fantasyfreedommod.player.FPlayer.AUTO_PURGE_TICKS;
...
public class FreezeData
{
    ...
    public void setFrozen(boolean freeze)
    {
        ...
        unfreeze = new BukkitRunnable()
        {
            ...
            public void run()
            {
                FUtil.adminAction("FantzsyFreedom", "Unfreezing " + player.getName(), false);
                setFrozen(false);
            }
