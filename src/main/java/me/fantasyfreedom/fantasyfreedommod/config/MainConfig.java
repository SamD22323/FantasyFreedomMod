package me.fantasyfreedom.fantasyfreedommod.config;
...
public class MainConfig extends PluginComponent<FantasyFreedomMod>
{
    ...
    public MainConfig(FantasyFreedomMod plugin)
    {
        super(plugin);
    ...
    {
        return plugin.getResource(FantasyFreedomMod.CONFIG_FILENAME);
    }
