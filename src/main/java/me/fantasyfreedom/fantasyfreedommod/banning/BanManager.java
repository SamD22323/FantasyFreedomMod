package me.fantasyfreedom.fantasyfreedommod.banning;
...
import me.fantasyfreedom.fantasyfreedommod.player.PlayerData;
...
public class BanManager extends FreedomService
{
    ...
    public BanManager(FantasyFreedomMod plugin)
    {
        super(plugin);
