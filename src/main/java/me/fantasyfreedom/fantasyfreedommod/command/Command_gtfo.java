...
public class Command_gtfo extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        FUtil.bcastMsg(player.getName() + " has been kicked out of the battle.", ChatColor.DARK_RED);
        ...
        // Kick player
        player.kickPlayer(ChatColor.RED + "YOU JUST GOT BANNED! D: Just kidding. GTFO");
